    ...
    <body>
        ...
        <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
            <div class="col-md-5 p-lg-5 mx-auto my-3">
                <h1 class="display-4 fw-normal">Pniel Fams</h1>
                <p class="fw-normal">Cek Ketersediaan -Booking  -Jangan lupa Bayar - Pake - Done</p>
                <p class="fw-normal" style="font-size: 40px" >JANGAN LUPA LOGIN TERLEBIH DAHULU ! </p>
                @if (!Auth::check())
        ...
        <footer class="py-5 bg-dark">
            <div class="container px-4"><p class="m-0 text-center text-white">&copy; 2024 pniel fams</p></div>
        </footer>
