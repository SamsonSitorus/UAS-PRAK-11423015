                ...
                <div class="col-md-12 col-lg-4">
                    <div class="card mb-4 shadow">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">@money( $detail->harga24 )<span class="badge bg-light text-dark" style="float: right;">3 Jam</span></li>
                            <li class="list-group-item">@money( $detail->harga12 )<span class="badge bg-light text-dark" style="float: right;">2 Jam</span></li>
                            <li class="list-group-item">@money( $detail->harga6 )<span class="badge bg-light text-dark" style="float: right;">1 Jam</span></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="card h-100 shadow">
                        <div class="card-body">
                            ...
                            <form action="{{ route('cart.store',['id' => $detail->id, 'userId' => Auth::user()->id]) }}" method="POST">
                                @csrf
                                <div class="d-flex">
                                    <button type="submit" class="btn btn-success mx-2" name="btn" value="24"><i class="fas fa-shopping-cart"></i> @money($detail->harga24) <b>3jam</b></button>
                                    <button type="submit" class="btn btn-success mx-2" name="btn" value="12"><i class="fas fa-shopping-cart"></i> @money($detail->harga12) <b>2jam</b></button>
                                    <button type="submit" class="btn btn-success mx-2" name="btn" value="6"><i class="fas fa-shopping-cart"></i> @money($detail->harga6) <b>1jam</b></button>
                                </div>
                            </form>
