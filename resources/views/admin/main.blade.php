...
<html lang="en">
    <head>
        ...
        <title>Admin Area - Booking Lapangan </title>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="sb-sidenav-menu-heading">Manajemen System</div>
                            ...
                            <a class="nav-link {{ Route::is('lokasi.index') ? 'active' : '' }}" href="{{ route('lokasi.index') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                lokasi
                            </a>
                            @endif
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; pniel</div>
                            <div>
