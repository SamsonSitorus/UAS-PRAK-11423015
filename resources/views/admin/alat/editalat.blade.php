                            ...
                            <div class="mb-3">
                                ...
                                <div class="row d-flex w-100 justify-content-start">
                                    <div class="input-group">
                                        ...
                                        <input type="number" value="{{ $alat->harga24 }}" name="harga24" class="form-control" placeholder="Harga 1jam" required>
                                        <span class="input-group-text"><b>/3jam</b></span>
                                    </div>
                                    <div class="input-group">
                                        <span class="input-group-text">Rp</span>
                                        <input type="number" value="{{ $alat->harga12 }}" name="harga12" class="form-control" placeholder="Harga 2jam" required>
                                        <span class="input-group-text"><b>/2jam</b></span>
                                    </div>
                                    <div class="input-group">
                                        <span class="input-group-text">Rp</span>
                                        <input type="number" value="{{ $alat->harga6 }}" name="harga6" class="form-control" placeholder="Harga 3jam" required>
                                        <span class="input-group-text"><b>/1jam</b></span>
                                    </div>
                                </div>
                                <div class="mt-3">
