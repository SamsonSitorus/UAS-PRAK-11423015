        ...
        <div class="row">
            ...
            <div class="col-lg">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <a type="button" class="btn btn-primary mb-4" data-bs-toggle="modal" data-bs-target="#tambahAlat">Tambah </a>
                            ...
                            <div class="col-6">
                                <div class="card h-100">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">@money($alat->harga24)<span class="badge bg-light text-dark" style="float: right;">3 Jam</span></li>
                                        <li class="list-group-item">@money($alat->harga12)<span class="badge bg-light text-dark" style="float: right;">2 Jam</span></li>
                                        <li class="list-group-item">@money($alat->harga6)<span class="badge bg-light text-dark" style="float: right;">1 Jam</span></li>
                                    </ul>
            ...
            <form action="{{ route('alat.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <div class="row">
                        ...
                        <div class="col col-4"><input type="number" name="harga24" class="form-control" placeholder="Harga 3jam" required></div>
                        <div class="col col-4"><input type="number" name="harga12" class="form-control" placeholder="Harga 2Jam" required></div>
                        <div class="col col-4"><input type="number" name="harga6" class="form-control" placeholder="Harga 1jam" required></div>
                    </div>
                </div>
                <div class="mb-3">
