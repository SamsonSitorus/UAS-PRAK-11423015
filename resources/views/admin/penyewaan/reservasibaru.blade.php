                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-footer">
                                        <form action="{{ route('cart.store',['id' => $item->id, 'userId' => $user->id]) }}" method="POST">
                                            @csrf
                                            <div class="d-block">
                                                <button type="submit" class="btn btn-success w-100 mt-2" name="btn" value="24"><i class="fas fa-shopping-cart"></i> @money($item->harga24) <b>3jam</b></button>
                                                <button type="submit" class="btn btn-success w-100 mt-2" name="btn" value="12"><i class="fas fa-shopping-cart"></i> @money($item->harga12) <b>2jam</b></button>
                                                <button type="submit" class="btn btn-success w-100 mt-2" name="btn" value="6"><i class="fas fa-shopping-cart"></i> @money($item->harga6) <b>1jam</b></button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
